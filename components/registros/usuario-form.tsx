...
export function UsuarioForm() {
  ...
  function handleSubmit(event: FormEvent) {
    ...
    const resultado = addUsuario({ nome: nome.trim(), email: email.trim(), papel })
    ...
    setSucesso(`Usuário "${nome.trim()}" criado com sucesso. Nesta etapa mockada, ele pode entrar com qualquer senha de 4+ caracteres.`)
    setNome("")
    setEmail("")
    setPapel("psicologo")
    setEnviando(false)
