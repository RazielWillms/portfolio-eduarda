-- Exposição controlada do cenário fictício para o modo de demonstração.
-- Não há impersonação: a função retorna somente o dataset identificado pelo
-- e-mail reservado da demonstração e não oferece qualquer operação de escrita.
...
begin
  ...
  where p.nome_completo like '%Demonstração%'
